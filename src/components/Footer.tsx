            ...
            <div className='w-5/6 h-4/6 rounded-3xl  bg-baseColor bg-clip-padding backdrop-filter backdrop-blur-[10px] bg-opacity-50 lg:px-12 px-6'>
                ...
                <div className=' w-full inline-flex justify-center items-center '>
                        <div className="relative md:w-1/3 w-full py-6 rounded-full " dir='rtl'>
                           ...
                           <input type="text" id="email-address-icon" className=" bg-white text-black/20 text-start inset-y-0 -start-0 rounded-full md:py-5 py-4 md:text-sm text-xs focus:ring-blue-500 focus:border-blue-500 block w-full md:ps-5 ps-5 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="your email@example.com" />
                           </div>
                            <div className="absolute inset-y-0 start-0 flex items-center md:ps-3.5 ps-2 pointer-events-none py-4">
                                <Button className='bg-baseColor rounded-full md:pl-6 pl-2 py-1 relative '><img src={Arrow} alt="" className='' /></Button>
                            </div>
                        </div>
                </div>
