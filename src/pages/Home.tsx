        ...
        <div className="mt-5">
            <div className="relative h-auto md:p-8 p-2 w-full overflow-hidden rounded-[10%]">
                ...
                <div className="relative z-10 w-full h-full flex md:flex-row flex-col p-8 md:p-24 md:items-end items-center justify-between gap-12">
                    <div className="w-full md:w-1/2 h-full flex flex-col justify-evenly items-start md:gap-44 gap-8">
                        <div className="flex flex-col gap-12 ab">
                    ...
                    <div className="w-full h-full flex flex-row justify-end gap-4 items-end relative mb-16 md:mb-4">
                        <div className="h-1/2  flex flex-col justify-center gap-4 items-end">
                            ...
                            <div className="w-full p-2 md:p-4 rounded-xl bg-white">
                                <div className="">
